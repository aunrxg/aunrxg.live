        ...
        <section className="">
          <FadeIn delay={0.2} className="pl-2">
            <div className="flex gap-5 items-center text-neutral-400 dark:text-neutral-500">
              <Link href="https://x.com/aunrxg" aria-label="X (Twitter)" className="hover:text-black dark:hover:text-white transition-colors">
              ...
              <Link href="https://linkedin.com/in/anurag-poddar-dev" aria-label="LinkedIn" className="hover:text-black dark:hover:text-white transition-colors">
